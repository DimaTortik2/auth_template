...
var SwitchBase = React13.forwardRef(function SwitchBase2(props, ref) {
  const {
    autoFocus,
    checked: checkedProp,
    checkedIcon,
...
true ? SwitchBase.propTypes = {
   ...
   */
  checkedIcon: import_prop_types10.default.node.isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   */
  icon: import_prop_types10.default.node.isRequired,
  /**
   ...
   */
  type: import_prop_types10.default.string.isRequired,
  /**
...
var Checkbox = React17.forwardRef(function Checkbox2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiCheckbox"
  });
  ...
  const [RootSlot, rootSlotProps] = useSlot("root", {
    ...
    additionalProps: {
      ...
      checkedIcon: React17.cloneElement(indeterminateIcon, {
...
true ? Checkbox.propTypes = {
   ...
   * @default false
   */
  indeterminate: import_prop_types11.default.bool,
  /**
   * The icon to display when the component is indeterminate.
   * @default <IndeterminateCheckBoxIcon />
   */
  indeterminateIcon: import_prop_types11.default.node,
  /**
   * [Attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#Attributes) applied to the `input` element.
